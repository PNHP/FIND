...
features = [el_pt, el_line, comm_poly, comm_pt, el_poly, survey_poly]
...
inputs = []
for feature, ins in zip(features, input_features):
    feature = arcpy.FeatureClassToFeatureClass_conversion(feature, "in_memory", ins)
...
def countyinfo(counties):
    ...
    for ins, output in zip(inputs, elementShapefiles):
        target_features = ins
